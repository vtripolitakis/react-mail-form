...
var _ButtonList = __webpack_require__(/*! ./components/ButtonList */ "./src/components/ButtonList.js");

var _ButtonList2 = _interopRequireDefault(_ButtonList);

var _MainFormContent = __webpack_require__(/*! ./components/MainFormContent */ "./src/components/MainFormContent.js");
...
var ReactMailForm = function (_React$Component) {
    ...
    function ReactMailForm(props) {
        ...
        var _this = _possibleConstructorReturn(this, (ReactMailForm.__proto__ || Object.getPrototypeOf(ReactMailForm)).call(this, props));
...
var ButtonList = function (_React$Component) {
    ...
    function ButtonList(props) {
        ...
        return _possibleConstructorReturn(this, (ButtonList.__proto__ || Object.getPrototypeOf(ButtonList)).call(this, props));
    }
...
/***/ "./src/components/MainFormContent.js":
/*!*******************************************!*\
  !*** ./src/components/MainFormContent.js ***!
  \*******************************************/
/*! no static exports found */
...
var MainFormContent = function (_React$Component) {
    ...
    function MainFormContent(props) {
        ...
        return _possibleConstructorReturn(this, (MainFormContent.__proto__ || Object.getPrototypeOf(MainFormContent)).call(this, props));
    }
    ...
    _createClass(MainFormContent, [{
        ...
        value: function render() {
            ...
            formData = Object.keys(this.props.content).map(function (i) {
                ...
                switch (objectData["type"]) {
                    ...
                    case "select":
                        ...
                        var select_data = objectData.options.map(function (j) {
                            ...
                            return _react2.default.createElement(
                                "option",
                                { key: j, selected: currentOptionSelected },
                                j
                            );
                        });
                        select_data.unshift(_react2.default.createElement(
                            "option",
                            { disabled: true, selected: !currentOptionSelected, key: "please select", value: "" },
                            "Please Select"
                        ));
                        outData = _react2.default.createElement(
                            "div",
                            ...
                            _react2.default.createElement(
                                ...
                                { required: isRequired,
                                    onChange: function onChange(e) {
                                        _this2.props.changeHandler(i, "select", e.target.value);
                                    } },
                                select_data
                            )
                        );
                ...
                var label = "";
                if (typeof _this2.props.content[i]["label"] === "undefined") {
                    label = i;
                } else {
                    label = _this2.props.content[i]["label"];
                }
                return _react2.default.createElement(
                    "div",
...
var _ReactMailForm = __webpack_require__(/*! ./ReactMailForm */ "./src/ReactMailForm.js");

var _ReactMailForm2 = _interopRequireDefault(_ReactMailForm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (typeof formConfigurationURL !== "undefined") {
    (0, _reactDom.render)(_react2.default.createElement(_ReactMailForm2.default, { formConfigurationURL: formConfigurationURL }), document.getElementById("root"));
} else {
    (0, _reactDom.render)(_react2.default.createElement(_ReactMailForm2.default, { formConfigurationURL: "example/config.json" }), document.getElementById("root"));
} /* jshint esversion: 6 */
...
/******/ });
//# sourceMappingURL=react-mail-form.js.map