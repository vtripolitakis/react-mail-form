...
(0, _reactDom.render)(_react2.default.createElement(_ReactMailForm2.default, { formConfigurationURL: "example/config.json" }), document.getElementById("root")); /* jshint esversion: 6 */
/* eslint no-unused-vars: ["error", { "varsIgnorePattern": "React" }] */
